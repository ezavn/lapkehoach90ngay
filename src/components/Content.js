...
const Content = () => {
  return (
    <section
      id="content"
      className="text-center content page-container md:mb-[75px] mb-[40px] md:px-[80px]"
    >
      <Title
        small
        className="md:mb-[38px] mb-[20px] text-[20px] md:text-[40px]"
      >
        NỘI DUNG CHƯƠNG TRÌNH GROWTH CLUB
      </Title>
      <div className="flex gap-x-[45px] gap-y-[20px] flex-col md:flex-row">
        <ContentList>
          ...
          <ContentItem kind="blank">
            "9:55 - 10:50: 5 WAYS - CÔNG THỨC TẠO RA DÒNG TIỀN TRONG DOANH
            NGHIỆP
          </ContentItem>
          <ContentItem>
        ...
        <ContentList title="Buổi CHIỀU">
          <ContentItem kind="secondary">
            13:30 - 13:35: Hoạt động "Follow the Leader" & QĐ bổ nhiệm Ban điều
            hành
          </ContentItem>
          <ContentItem kind="blank">
          ...
          <ContentItem kind="blank">
            15:40 - 16:00: Giới thiệu GrowthCLUB Tháng 12/2022 & Kêu gọi ngành
            nghề
          </ContentItem>
          <ContentItem kind="secondary">
...
const ContentList = ({ title = "Buổi Sáng", children }) => {
  return (
    <div className="p-[15px] md:p-7 border-[12px] border-solid border-primary rounded-[10px] bg-white">
...
const ContentItem = ({
  ...
  return (
    <div
      className={`flex items-center text-left w-full max-w-[440px] py-[15px] pr-[13px] pl-[30px] h-[76px] ${bgColor}`}
    >
